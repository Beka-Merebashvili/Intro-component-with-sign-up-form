  ...
  return (
    <FormContainer>
      ...
      <StyledForm
        ...
        email={email}
        emailInvaild={emailInvaild}
        paswword={paswword}
        emptyPassword={emptyPassword}
        lessThen4={lessThen4}
        lessThen4Lastname={lessThen4Lastname}
        lessThen4Password={lessThen4Password}
      >
        <div className="inputContainer">
          <input
            ...
            onChange={(event) => {
              if (
                firstNameRegex.test(event.target.value) ||
                event.target.value == ""
              ) {
          ...
          />
          {emptyUsername && (
            <p className="errorText">First Name cannot be empty</p>
          )}
          {lessThen4 && (
          ...
          {
            <img
              className={emptyUsername || lessThen4 ? "errorIcon" : "none"}
              src={errorImg}
            />
          }
        </div>
        ...
        <div className="inputContainer">
          ...
          />
          {emptyLastname && (
            <p className="errorText">Last Name cannot be empty</p>
          )}
          {lessThen4Lastname && (
            <p className="errorText">
          ...
          )}
          {
            <img
              className={
                emptyLastname || lessThen4Lastname ? "errorIcon" : "none"
              }
              src={errorImg}
            />
          }
        ...
        <div className="inputContainer">
          ...
          />
          {emailInvaild && (
            <p className="errorText">Looks like this is not an email</p>
          )}
        ...
        <div className="inputContainer">
          ...
          )}
          {
            <img
              className={
                emptyPassword || lessThen4Password ? "errorIcon" : "none"
              }
              src={errorImg}
            />
          }
        ...
        <button
          onClick={(event) => {
            ...
            if (
              ...
              (paswword.length > 0 && paswword.length < 6)
            ) {
...
const StyledForm = styled.form`
  ...
  .usernameInput {
    border: ${(props) =>
      props.emptyUsername || props.lessThen4
        ? "2px solid #FF7979"
        : "1px solid #DEDEDE"};
  }
  .lastnameInput {
    border: ${(props) =>
      props.emptyLastname || props.lessThen4Lastname
        ? "2px solid #FF7979"
        : "1px solid #DEDEDE"};
  }
  .emailInput {
    border: ${(props) =>
      props.emailInvaild ? "2px solid #FF7979" : "1px solid #DEDEDE"};
  }
  .passwordInput {
    border: ${(props) =>
      props.emptyPassword || props.lessThen4Password
        ? "2px solid #FF7979"
        : "1px solid #DEDEDE"};
  }
  .errorText {
